...
# Scaling laws for Aurora

This repo is based on the official [Microsoft implementation](https://github.com/microsoft/aurora) and [ESFM](https://github.com/swiss-ai/ESFM). ESFM includes a re-implementation of the training loop in PyTorch Lightning and a new stateful dataloader to enable flexible checkpointing and reliable resumption. We acknowledge Yun Cheng, Firat Ozdemir, and Salman Mohebi for the implementation of the trainer in ESFM.


---
### README from [source repo](https://github.com/microsoft/aurora) below
...
- [Aurora: A Foundation Model of the Atmosphere](#aurora-a-foundation-model-of-the-atmosphere)
  ...
  - [Responsible AI Transparency Documentation](#responsible-ai-transparency-documentation)
    - [Use of this code](#use-of-this-code)
    - [Limitations](#limitations)
    - [Data](#data)
    - [Evaluations](#evaluations)
  - [Trademarks](#trademarks)
  - [FAQ](#faq)
    - [How do I setup the repo for local development?](#how-do-i-setup-the-repo-for-local-development)
    - [Why is the fine-tuned version of Aurora for air quality forecasting missing?](#why-is-the-fine-tuned-version-of-aurora-for-air-quality-forecasting-missing)
