...
class NetCDFDataset(data.Dataset):
    ...
    def __init__(self,
                 nc_path='/scratch/pangu/data_storage_home/data/pangu',
                 data_transform=None,
                 seed=1234,
                 training=True,
                 validation=False,
...
# use zarr statistics, ignore this
def weatherStatistics_output(filepath="/scratch/pangu/data_storage_home/data/pangu/aux_data", device="cpu"):
    """
    :return:1, 5, 13, 1, 1
    """
...
# use zarr statistics, ignore this
def weatherStatistics_input(filepath="/scratch/pangu/data_storage_home/data/pangu/aux_data", device="cpu"):
    """
    :return:13, 1, 1, 5
    """
    surface_mean = np.load(os.path.join(filepath, "surface_mean.npy")).astype(np.float32)
...
def LoadConstantMask(filepath='/data/Pangu-Weather/constant_masks', device="cpu"):
...
# what is this?
def LoadConstantMask3(filepath="/scratch/pangu/data_storage_home/data/pangu/aux_data", device="cpu"):
...
def loadConstMask_h(filepath="/scratch/pangu/data_storage_home/data/pangu/aux_data", device="cpu"):
...
if __name__ == "__main__":
    # dataset_path ='/scratch/pangu/data_storage_home/data/pangu'
