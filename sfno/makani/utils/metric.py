...
class MetricsHandler:
    ...
    def __init__(
        ...
        acc_vars_names=["10u", "t2m", "u500", "z500", "r500", "q500"],
        acc_auc_var_names=["10u", "t2m", "u500", "z500", "r500", "q500"],
    ):
        self.device = device
    ...
    def update(self, prediction, target, loss, idt):
        ...
        # print("target", target)
        sum_rmse = torch.sum(self.rmse_handle(prediction, target), dim=0)
        # print("sum_rmse", sum_rmse)
        self.rmse_curve[:, idt] += self.mult * sum_rmse
    ...
    def finalize(self, final_inference=False):
        ...
        # called after every validation step
